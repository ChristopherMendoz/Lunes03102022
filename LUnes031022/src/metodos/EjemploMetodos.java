...
public class EjemploMetodos {
	...
	public static void main(String[] args) {
		...
		//MetodoA no quiere datos de entrada y no devuelve valor
        metodoA();
        //MetodoB quiere datos de entrada y no devuelve valor
        metodoB(3.2 , 5.0 , 8);
        double a = 9.3, b = 7.5;
        int c = 5;
        metodoB(a,b,c);
		...
		c = lector.nextInt();
		metodoB(a,b,c);
		 //MetodoC no quiere datos de entrada y pero si devuelve valor tipo double
		double result = metodoC();
		System.out.println("El resultado es = " + result);
		System.out.println("El resultado es = " + metodoC());
		//MetodoD requiere datos de entrada y tambien devuelve un valor double
		System.out.println("El resultado es = " + metodoD(1.0,2.0,5.0,9));
		lector.close();
	}
	...
	private static double metodoC() {
		double varDouble1 = 1.0,  varInt1 = 5.0, varDouble2 = 2.0 ;
		int varInt2 = 9;
